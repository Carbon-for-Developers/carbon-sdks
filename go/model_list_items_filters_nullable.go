...
type ListItemsFiltersNullable struct {
	...
	ItemTypes []SIHFNZCGABTypes1 `json:"item_types,omitempty"`
}
...
// SetItemTypes gets a reference to the given []SIHFNZCGABTypes1 and assigns it to the ItemTypes field.
