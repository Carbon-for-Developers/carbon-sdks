...
func (r AuthApiGetAccessTokenRequest) Execute() (*TokenResponse, *http.Response, error) {
...
func (a *AuthApiService) GetAccessTokenExecute(r AuthApiGetAccessTokenRequest) (*TokenResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/auth/v1/access_token"
...
func (r AuthApiGetWhiteLabelingRequest) Execute() (*WhiteLabelingResponse, *http.Response, error) {
	return r.ApiService.GetWhiteLabelingExecute(r)
}
...
func (a *AuthApiService) GetWhiteLabelingExecute(r AuthApiGetWhiteLabelingRequest) (*WhiteLabelingResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *WhiteLabelingResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.GetWhiteLabeling")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/auth/v1/white_labeling"
