...
// OANSCZGFB struct for OANSCZGFB
type OANSCZGFB struct {
...
func (o *OANSCZGFB) SetRefreshTokenNil() {
...
func (o *OANSCZGFB) SetEndpointUrlNil() {
...
func (o OANSCZGFB) MarshalJSON() ([]byte, error) {
...
type NullableOANSCZGFB struct {
	value *OANSCZGFB
	isSet bool
}

func (v NullableOANSCZGFB) Get() *OANSCZGFB {
	return v.value
}

func (v *NullableOANSCZGFB) Set(val *OANSCZGFB) {
	v.value = val
	v.isSet = true
}

func (v NullableOANSCZGFB) IsSet() bool {
	return v.isSet
}

func (v *NullableOANSCZGFB) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOANSCZGFB(val *OANSCZGFB) *NullableOANSCZGFB {
	return &NullableOANSCZGFB{value: val, isSet: true}
}

func (v NullableOANSCZGFB) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOANSCZGFB) UnmarshalJSON(src []byte) error {
	v.isSet = true
