...
type UtilitiesApiFetchWebpageRequest struct {
	ctx context.Context
	ApiService *UtilitiesApiService
	fetchURLsRequest FetchURLsRequest
}

func (r UtilitiesApiFetchWebpageRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.FetchWebpageExecute(r)
}

/*
FetchWebpage Fetch Urls V2

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param fetchURLsRequest
 @return UtilitiesApiFetchWebpageRequest
*/
func (a *UtilitiesApiService) FetchWebpage(fetchURLsRequest FetchURLsRequest) UtilitiesApiFetchWebpageRequest {
	return UtilitiesApiFetchWebpageRequest{
		ApiService: a,
		ctx: a.client.cfg.Context,
		fetchURLsRequest: fetchURLsRequest,
...
func (a *UtilitiesApiService) FetchWebpageExecute(r UtilitiesApiFetchWebpageRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UtilitiesApiService.FetchWebpage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type UtilitiesApiUserWebpagesRequest struct {
	ctx context.Context
	ApiService *UtilitiesApiService
	userWebPagesRequest UserWebPagesRequest
}

func (r UtilitiesApiUserWebpagesRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.UserWebpagesExecute(r)
}

/*
UserWebpages User Web Pages

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param userWebPagesRequest
 @return UtilitiesApiUserWebpagesRequest
*/
func (a *UtilitiesApiService) UserWebpages(userWebPagesRequest UserWebPagesRequest) UtilitiesApiUserWebpagesRequest {
	return UtilitiesApiUserWebpagesRequest{
		ApiService: a,
		ctx: a.client.cfg.Context,
		userWebPagesRequest: userWebPagesRequest,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *UtilitiesApiService) UserWebpagesExecute(r UtilitiesApiUserWebpagesRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UtilitiesApiService.UserWebpages")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
