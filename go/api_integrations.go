...
type IntegrationsApiConnectDocument360Request struct {
	ctx context.Context
	ApiService *IntegrationsApiService
	document360ConnectRequest Document360ConnectRequest
}

func (r IntegrationsApiConnectDocument360Request) Execute() (*GenericSuccessResponse, *http.Response, error) {
	return r.ApiService.ConnectDocument360Execute(r)
}

/*
ConnectDocument360 Document360 Connect
...
here https://apidocs.document360.com/apidocs/api-token.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param document360ConnectRequest
 @return IntegrationsApiConnectDocument360Request
*/
func (a *IntegrationsApiService) ConnectDocument360(document360ConnectRequest Document360ConnectRequest) IntegrationsApiConnectDocument360Request {
	return IntegrationsApiConnectDocument360Request{
		ApiService: a,
		ctx: a.client.cfg.Context,
		document360ConnectRequest: document360ConnectRequest,
...
func (a *IntegrationsApiService) ConnectDocument360Execute(r IntegrationsApiConnectDocument360Request) (*GenericSuccessResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsApiService.ConnectDocument360")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

    subpath := "/integrations/document360"
	localVarPath := localBasePath + subpath
	if a.client.cfg.Host != "" {
		localVarPath = a.client.cfg.Scheme + "://" + a.client.cfg.Host + subpath
	}
	...
	// body params
    if !checkNilInterface(r.document360ConnectRequest) {
        localVarPostBody = r.document360ConnectRequest
    }
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
...
type IntegrationsApiListSharepointSitesRequest struct {
	ctx context.Context
	ApiService *IntegrationsApiService
	dataSourceId *int32
	cursor *string
...
func (r *IntegrationsApiListSharepointSitesRequest) DataSourceId(dataSourceId int32) *IntegrationsApiListSharepointSitesRequest {
	r.dataSourceId = &dataSourceId
	return r
}

func (r *IntegrationsApiListSharepointSitesRequest) Cursor(cursor string) *IntegrationsApiListSharepointSitesRequest {
	r.cursor = &cursor
	return r
}

func (r IntegrationsApiListSharepointSitesRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.ListSharepointSitesExecute(r)
}

/*
ListSharepointSites List Sharepoint Sites
...
cursor: Used for pagination. If next_cursor is returned in response, you need to pass it as the cursor in the next request
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return IntegrationsApiListSharepointSitesRequest
*/
func (a *IntegrationsApiService) ListSharepointSites() IntegrationsApiListSharepointSitesRequest {
	return IntegrationsApiListSharepointSitesRequest{
		ApiService: a,
		ctx: a.client.cfg.Context,
	}
...
// Execute executes the request
//  @return map[string]interface{}
func (a *IntegrationsApiService) ListSharepointSitesExecute(r IntegrationsApiListSharepointSitesRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsApiService.ListSharepointSites")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

    subpath := "/integrations/sharepoint/sites/list"
	localVarPath := localBasePath + subpath
	if a.client.cfg.Host != "" {
		localVarPath = a.client.cfg.Scheme + "://" + a.client.cfg.Host + subpath
	}
