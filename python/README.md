...
[![PyPI](https://img.shields.io/badge/PyPI-v0.2.36-blue)](https://pypi.org/project/carbon-python-sdk/0.2.36)
...
```sh
pip install carbon-python-sdk==0.2.36
```
...
##### authentication: Union[`OAuthAuthentication`, `NotionAuthentication`, `SharepointAuthentication`, `ConfluenceAuthentication`, `ZendeskAuthentication`, `ZoteroAuthentication`, `GitbookAuthetication`, `SalesforceAuthentication`, `FreskdeskAuthentication`, `S3Authentication`, `AzureBlobStorageAuthentication`, `GithubAuthentication`, `ServiceNowAuthentication`, `GuruAuthentication`, `GongAuthentication`]<a id="authentication-unionoauthauthentication-notionauthentication-sharepointauthentication-confluenceauthentication-zendeskauthentication-zoteroauthentication-gitbookauthetication-salesforceauthentication-freskdeskauthentication-s3authentication-azureblobstorageauthentication-githubauthentication-servicenowauthentication-guruauthentication-gongauthentication"></a>
