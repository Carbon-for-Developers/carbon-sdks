...
class BaseApi(api_client.Api):
    ...
    def _get_white_labeling_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_white_labeling_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/auth/v1/white_labeling',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetWhiteLabelingRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_white_labeling(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        return await self._aget_white_labeling_oapg(
            **kwargs,
        )
    
    def get_white_labeling(
        self,
    ) -> typing.Union[
        ApiResponseFor200,
        api_client.ApiResponseWithoutDeserialization,
...
class GetWhiteLabeling(BaseApi):

    async def aget_white_labeling(
        self,
        validate: bool = False,
        **kwargs,
    ) -> WhiteLabelingResponsePydantic:
        raw_response = await self.raw.aget_white_labeling(
            **kwargs,
        )
        if validate:
            return WhiteLabelingResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WhiteLabelingResponsePydantic, raw_response.body)
    ...
    def get_white_labeling(
        ...
        raw_response = self.raw.get_white_labeling(
        )
        if validate:
            return WhiteLabelingResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WhiteLabelingResponsePydantic, raw_response.body)
