...
class Get(BaseApi):
    ...
    async def aget(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OrganizationResponsePydantic:
        raw_response = await self.raw.aget(
            **kwargs,
        )
        if validate:
            return OrganizationResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(OrganizationResponsePydantic, raw_response.body)
