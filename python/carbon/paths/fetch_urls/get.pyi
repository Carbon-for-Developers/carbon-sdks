...
class FetchUrlsRaw(BaseApi):
    ...
    async def afetch_urls(
        ...
        **kwargs,
        ...
        args = self._fetch_urls_mapped_args(
            url=url,
        )
        return await self._afetch_urls_oapg(
...
class FetchUrls(BaseApi):
    ...
    async def afetch_urls(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afetch_urls(
            url=url,
            **kwargs,
        )
        if validate:
    ...
    def fetch_urls(
        ...
        raw_response = self.raw.fetch_urls(
            url=url,
        )
        if validate:
            return FetchURLsResponsePydantic(**raw_response.body)
