...
from carbon.model.azure_blob_get_file_input import AzureBlobGetFileInput as AzureBlobGetFileInputSchema
from carbon.model.azure_blob_file_sync_input import AzureBlobFileSyncInput as AzureBlobFileSyncInputSchema
...
from carbon.type.azure_blob_file_sync_input import AzureBlobFileSyncInput

from ...api_client import Dictionary
from carbon.pydantic.azure_blob_file_sync_input import AzureBlobFileSyncInput as AzureBlobFileSyncInputPydantic
from carbon.pydantic.http_validation_error import HTTPValidationError as HTTPValidationErrorPydantic
from carbon.pydantic.azure_blob_get_file_input import AzureBlobGetFileInput as AzureBlobGetFileInputPydantic
...
# body param
SchemaForRequestBodyApplicationJson = AzureBlobFileSyncInputSchema


request_body_azure_blob_file_sync_input = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _sync_azure_blob_files_mapped_args(
        self,
    ...
    async def _async_azure_blob_files_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/integrations/azure_blob_storage/files',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_azure_blob_file_sync_input.serialize(body, content_type)
    ...
    def _sync_azure_blob_files_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class SyncAzureBlobFilesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def async_azure_blob_files(
        self,
        ids: typing.List[AzureBlobGetFileInput],
        tags: typing.Optional[typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]]] = None,
        chunk_size: typing.Optional[typing.Optional[int]] = None,
        ...
        **kwargs,
        ...
        args = self._sync_azure_blob_files_mapped_args(
            ids=ids,
            tags=tags,
        ...
        return await self._async_azure_blob_files_oapg(
            body=args.body,
            **kwargs,
        )
    
    def sync_azure_blob_files(
        self,
        ids: typing.List[AzureBlobGetFileInput],
        tags: typing.Optional[typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]]] = None,
        chunk_size: typing.Optional[typing.Optional[int]] = None,
        ...
        return self._sync_azure_blob_files_oapg(
            body=args.body,
        )

class SyncAzureBlobFiles(BaseApi):
    ...
    async def async_azure_blob_files(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.async_azure_blob_files(
            ids=ids,
            tags=tags,
            chunk_size=chunk_size,
            chunk_overlap=chunk_overlap,
    ...
    def sync_azure_blob_files(
        ...
        raw_response = self.raw.sync_azure_blob_files(
            ids=ids,
            tags=tags,
            chunk_size=chunk_size,
            chunk_overlap=chunk_overlap,
