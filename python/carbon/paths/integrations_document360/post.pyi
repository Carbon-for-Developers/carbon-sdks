...
from carbon.model.document360_connect_request import Document360ConnectRequest as Document360ConnectRequestSchema
...
from carbon.type.document360_connect_request import Document360ConnectRequest
...
from carbon.pydantic.document360_connect_request import Document360ConnectRequest as Document360ConnectRequestPydantic
from carbon.pydantic.file_sync_config_nullable import FileSyncConfigNullable as FileSyncConfigNullablePydantic

# body param
SchemaForRequestBodyApplicationJson = Document360ConnectRequestSchema


request_body_document360_connect_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _connect_document360_mapped_args(
        self,
        account_email: str,
        access_token: str,
        ...
        if account_email is not None:
            _body["account_email"] = account_email
    ...
    async def _aconnect_document360_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/integrations/document360',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_document360_connect_request.serialize(body, content_type)
...
class ConnectDocument360Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aconnect_document360(
        self,
        account_email: str,
        access_token: str,
        tags: typing.Optional[typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]]] = None,
        ...
        **kwargs,
        ...
        args = self._connect_document360_mapped_args(
        ...
        return await self._aconnect_document360_oapg(
            body=args.body,
            **kwargs,
        )
    
    def connect_document360(
        self,
        account_email: str,
        access_token: str,
        tags: typing.Optional[typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]]] = None,
        ...
        return self._connect_document360_oapg(
            body=args.body,
        )

class ConnectDocument360(BaseApi):
    ...
    async def aconnect_document360(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aconnect_document360(
            account_email=account_email,
            access_token=access_token,
            tags=tags,
            chunk_size=chunk_size,
    ...
    def connect_document360(
        ...
        raw_response = self.raw.connect_document360(
            account_email=account_email,
            access_token=access_token,
            tags=tags,
            chunk_size=chunk_size,
