    ...
    async def _acancel_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/integrations/items/sync/cancel',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class Cancel(BaseApi):
    ...
    async def acancel(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acancel(
            data_source_id=data_source_id,
            **kwargs,
        )
        if validate:
