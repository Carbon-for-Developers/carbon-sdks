...
class QueryRaw(BaseApi):
    ...
    async def aquery(
        ...
        **kwargs,
        ...
        args = self._query_mapped_args(
            pagination=pagination,
            order_by=order_by,
            order_dir=order_dir,
            filters=filters,
        )
        return await self._aquery_oapg(
            body=args.body,
            **kwargs,
        )
...
class Query(BaseApi):
    ...
    async def aquery(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aquery(
            pagination=pagination,
            order_by=order_by,
            order_dir=order_dir,
            filters=filters,
