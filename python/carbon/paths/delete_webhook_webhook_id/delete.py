...
# Path params
WebhookIdSchema = schemas.IntSchema
    ...
    async def _adelete_url_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/delete_webhook/{webhook_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class DeleteUrlRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_url(
        self,
        webhook_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        return await self._adelete_url_oapg(
    ...
    def delete_url(
        ...
        return self._delete_url_oapg(
            path_params=args.path,
        )

class DeleteUrl(BaseApi):
    ...
    async def adelete_url(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_url(
            webhook_id=webhook_id,
            **kwargs,
        )
        if validate:
    ...
    def delete_url(
        ...
        raw_response = self.raw.delete_url(
            webhook_id=webhook_id,
        )
        if validate:
            return GenericSuccessResponsePydantic(**raw_response.body)
