...
from carbon.model.slack_sync_request import SlackSyncRequest as SlackSyncRequestSchema
from carbon.model.embedding_generators import EmbeddingGenerators as EmbeddingGeneratorsSchema
from carbon.model.slack_filters import SlackFilters as SlackFiltersSchema

from carbon.type.embedding_generators import EmbeddingGenerators
from carbon.type.http_validation_error import HTTPValidationError
from carbon.type.slack_sync_request import SlackSyncRequest
from carbon.type.slack_filters import SlackFilters
...
from carbon.pydantic.slack_filters import SlackFilters as SlackFiltersPydantic
from carbon.pydantic.slack_sync_request import SlackSyncRequest as SlackSyncRequestPydantic

# body param
SchemaForRequestBodyApplicationJson = SlackSyncRequestSchema


request_body_slack_sync_request = api_client.RequestBody(
    content={
    ...
    async def _async_slack_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/integrations/slack/sync',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_slack_sync_request.serialize(body, content_type)
...
class SyncSlackRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def async_slack(
        self,
        filters: SlackFilters,
        tags: typing.Optional[typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]]] = None,
        chunk_size: typing.Optional[typing.Optional[int]] = None,
        ...
        **kwargs,
        ...
        return await self._async_slack_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def sync_slack(
        ...
        return self._sync_slack_oapg(
            body=args.body,
        )

class SyncSlack(BaseApi):
    ...
    async def async_slack(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.async_slack(
            filters=filters,
            tags=tags,
            chunk_size=chunk_size,
            chunk_overlap=chunk_overlap,
    ...
    def sync_slack(
        ...
        raw_response = self.raw.sync_slack(
            filters=filters,
            tags=tags,
            chunk_size=chunk_size,
            chunk_overlap=chunk_overlap,
