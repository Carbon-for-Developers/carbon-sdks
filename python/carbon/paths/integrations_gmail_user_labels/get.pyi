    ...
    async def _alist_labels_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/integrations/gmail/user_labels',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListLabelsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_labels(
        self,
        data_source_id: typing.Optional[typing.Optional[int]] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        return await self._alist_labels_oapg(
...
class ListLabels(BaseApi):
    ...
    async def alist_labels(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_labels(
            data_source_id=data_source_id,
            **kwargs,
        )
        if validate:
    ...
    def list_labels(
        ...
        raw_response = self.raw.list_labels(
            data_source_id=data_source_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
