...
class BaseApi(api_client.Api):
    ...
    def _list_gitbook_spaces_mapped_args(
        self,
        data_source_id: int,
    ...
    async def _alist_gitbook_spaces_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/integrations/gitbook/spaces',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListGitbookSpacesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_gitbook_spaces(
        self,
        data_source_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        return await self._alist_gitbook_spaces_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_gitbook_spaces(
        self,
        data_source_id: int,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._list_gitbook_spaces_oapg(
            query_params=args.query,
        )

class ListGitbookSpaces(BaseApi):
    ...
    async def alist_gitbook_spaces(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_gitbook_spaces(
            data_source_id=data_source_id,
            **kwargs,
        )
        if validate:
    ...
    def list_gitbook_spaces(
        ...
        raw_response = self.raw.list_gitbook_spaces(
            data_source_id=data_source_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
