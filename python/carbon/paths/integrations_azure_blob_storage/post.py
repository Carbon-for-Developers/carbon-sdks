...
from carbon.model.azure_blob_auth_request import AzureBlobAuthRequest as AzureBlobAuthRequestSchema
...
from carbon.type.azure_blob_auth_request import AzureBlobAuthRequest
from carbon.type.organization_user_data_source_api import OrganizationUserDataSourceAPI

from ...api_client import Dictionary
from carbon.pydantic.http_validation_error import HTTPValidationError as HTTPValidationErrorPydantic
from carbon.pydantic.azure_blob_auth_request import AzureBlobAuthRequest as AzureBlobAuthRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = AzureBlobAuthRequestSchema


request_body_azure_blob_auth_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _sync_azure_blob_storage_mapped_args(
        self,
        account_name: str,
        account_key: str,
        ...
        if account_name is not None:
            _body["account_name"] = account_name
        if account_key is not None:
            _body["account_key"] = account_key
    ...
    async def _async_azure_blob_storage_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/integrations/azure_blob_storage',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_azure_blob_auth_request.serialize(body, content_type)
    ...
    def _sync_azure_blob_storage_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class SyncAzureBlobStorageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def async_azure_blob_storage(
        self,
        account_name: str,
        account_key: str,
        sync_source_items: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._sync_azure_blob_storage_mapped_args(
            account_name=account_name,
            account_key=account_key,
            sync_source_items=sync_source_items,
            data_source_tags=data_source_tags,
        )
        return await self._async_azure_blob_storage_oapg(
            body=args.body,
            **kwargs,
        )
    
    def sync_azure_blob_storage(
        self,
        account_name: str,
        account_key: str,
        sync_source_items: typing.Optional[bool] = None,
        ...
        return self._sync_azure_blob_storage_oapg(
            body=args.body,
        )

class SyncAzureBlobStorage(BaseApi):
    ...
    async def async_azure_blob_storage(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.async_azure_blob_storage(
            account_name=account_name,
            account_key=account_key,
            sync_source_items=sync_source_items,
            data_source_tags=data_source_tags,
    ...
    def sync_azure_blob_storage(
        ...
        raw_response = self.raw.sync_azure_blob_storage(
            account_name=account_name,
            account_key=account_key,
            sync_source_items=sync_source_items,
            data_source_tags=data_source_tags,
