...
from carbon.model.embeddings_and_chunks_query_input_v2 import EmbeddingsAndChunksQueryInputV2 as EmbeddingsAndChunksQueryInputV2Schema
...
from carbon.type.embeddings_and_chunks_query_input_v2 import EmbeddingsAndChunksQueryInputV2
...
from carbon.pydantic.embeddings_and_chunks_query_input_v2 import EmbeddingsAndChunksQueryInputV2 as EmbeddingsAndChunksQueryInputV2Pydantic
...
# body param
SchemaForRequestBodyApplicationJson = EmbeddingsAndChunksQueryInputV2Schema


request_body_embeddings_and_chunks_query_input_v2 = api_client.RequestBody(
    content={
    ...
    async def _alist_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/list_chunks_and_embeddings',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_embeddings_and_chunks_query_input_v2.serialize(body, content_type)
