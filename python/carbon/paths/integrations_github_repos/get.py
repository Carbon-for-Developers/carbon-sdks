    ...
    async def _alist_repos_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/integrations/github/repos',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListReposRaw(BaseApi):
    ...
    async def alist_repos(
        ...
        **kwargs,
        ...
        return await self._alist_repos_oapg(
    ...
    def list_repos(
        ...
        return self._list_repos_oapg(
            query_params=args.query,
        )

class ListRepos(BaseApi):
    ...
    async def alist_repos(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_repos(
            per_page=per_page,
            page=page,
            data_source_id=data_source_id,
            **kwargs,
    ...
    def list_repos(
        ...
        raw_response = self.raw.list_repos(
            per_page=per_page,
            page=page,
            data_source_id=data_source_id,
        )
