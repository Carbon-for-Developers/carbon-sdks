...
class DeleteWhiteLabelRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def ids() -> typing.Type['DeleteWhiteLabelRequestIds']:
                return DeleteWhiteLabelRequestIds
            __annotations__ = {
                "ids": ids,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ids"]) -> 'DeleteWhiteLabelRequestIds': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ids"]) -> 'DeleteWhiteLabelRequestIds': ...
