...
class EmbeddingsAndChunksFilters(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["user_file_id", "embedding_model", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["user_file_id", "embedding_model", ], str]):
