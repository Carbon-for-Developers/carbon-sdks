...
class Credentials(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["client_id", "redirect_uri", "client_secret", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["client_id", "redirect_uri", "client_secret", ], str]):
