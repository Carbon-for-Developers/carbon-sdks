...
class HelpdeskGlobalFileSyncConfigNullable(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sync_attachments", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sync_attachments", ], str]):
