...
class GithubAuthentication(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["source", "access_token", "username", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["source", "access_token", "username", ], str]):
