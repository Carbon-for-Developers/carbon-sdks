...
class OutlookSyncInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["filters", "tags", "folder", "chunk_size", "chunk_overlap", "skip_embedding_generation", "embedding_model", "generate_sparse_vectors", "prepend_filename_to_chunks", "data_source_id", "request_id", "sync_attachments", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["filters", "tags", "folder", "chunk_size", "chunk_overlap", "skip_embedding_generation", "embedding_model", "generate_sparse_vectors", "prepend_filename_to_chunks", "data_source_id", "request_id", "sync_attachments", ], str]):
