...
class ModifyColdStorageParametersQueryInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["filters", "enable_cold_storage", "hot_storage_time_to_live", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["filters", "enable_cold_storage", "hot_storage_time_to_live", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        enable_cold_storage: typing.Union[MetaOapg.properties.enable_cold_storage, None, bool, schemas.Unset] = schemas.unset,
