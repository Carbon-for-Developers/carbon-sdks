...
class AzureBlobGetFileInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "container", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "container", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        container: typing.Union[MetaOapg.properties.container, None, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
