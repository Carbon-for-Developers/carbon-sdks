...
class NotionAuthentication(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["source", "access_token", "workspace_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["source", "access_token", "workspace_id", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        workspace_id: typing.Union[MetaOapg.properties.workspace_id, str, ],
