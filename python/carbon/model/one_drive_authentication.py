...
class OneDriveAuthentication(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["source", "access_token", "refresh_token", "tenant_name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["source", "access_token", "refresh_token", "tenant_name", ], str]):
