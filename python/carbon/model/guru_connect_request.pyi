...
class GuruConnectRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["username", "access_token", "tags", "chunk_size", "chunk_overlap", "skip_embedding_generation", "embedding_model", "generate_sparse_vectors", "prepend_filename_to_chunks", "sync_files_on_connection", "request_id", "sync_source_items", "file_sync_config", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["username", "access_token", "tags", "chunk_size", "chunk_overlap", "skip_embedding_generation", "embedding_model", "generate_sparse_vectors", "prepend_filename_to_chunks", "sync_files_on_connection", "request_id", "sync_source_items", "file_sync_config", ], str]):
