...
class HybridSearchTuningParams(
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        weight_a: typing.Union[MetaOapg.properties.weight_a, decimal.Decimal, int, float, ],
        weight_b: typing.Union[MetaOapg.properties.weight_b, decimal.Decimal, int, float, ],
