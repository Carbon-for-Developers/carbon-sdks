        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['EmbeddingAndChunk']:
                        return EmbeddingAndChunk
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['EmbeddingAndChunk'], typing.List['EmbeddingAndChunk']],
                ...
                def __getitem__(self, i: int) -> 'EmbeddingAndChunk':
