...
class AddDataSourceTagsInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tags", "data_source_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tags", "data_source_id", ], str]):
