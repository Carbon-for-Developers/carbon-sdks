...
class RequiredGuruConnectRequest(TypedDict):
    username: str

    access_token: str


class OptionalGuruConnectRequest(TypedDict, total=False):
...
class GuruConnectRequest(RequiredGuruConnectRequest, OptionalGuruConnectRequest):
    pass
