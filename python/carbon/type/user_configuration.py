...
class RequiredUserConfiguration(TypedDict):
    pass

class OptionalUserConfiguration(TypedDict, total=False):
...
class UserConfiguration(RequiredUserConfiguration, OptionalUserConfiguration):
    pass
