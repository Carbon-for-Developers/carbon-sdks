...
class RequiredDocument360ConnectRequest(TypedDict):
...
class OptionalDocument360ConnectRequest(TypedDict, total=False):
...
class Document360ConnectRequest(RequiredDocument360ConnectRequest, OptionalDocument360ConnectRequest):
    pass
