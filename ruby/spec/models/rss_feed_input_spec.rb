...
# Unit tests for Carbon::RSSFeedInput
describe Carbon::RSSFeedInput do
  let(:instance) { Carbon::RSSFeedInput.new }

  describe 'test an instance of RSSFeedInput' do
    it 'should create an instance of RSSFeedInput' do
      expect(instance).to be_instance_of(Carbon::RSSFeedInput)
    end
  end
