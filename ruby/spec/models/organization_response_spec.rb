...
# Unit tests for Carbon::OrganizationResponse
describe Carbon::OrganizationResponse do
  let(:instance) { Carbon::OrganizationResponse.new }

  describe 'test an instance of OrganizationResponse' do
    it 'should create an instance of OrganizationResponse' do
      expect(instance).to be_instance_of(Carbon::OrganizationResponse)
    end
  end
  ...
  describe 'test attribute "custom_branding"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
