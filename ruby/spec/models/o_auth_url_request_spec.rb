...
# Unit tests for Carbon::OAuthURLRequest
describe Carbon::OAuthURLRequest do
  let(:instance) { Carbon::OAuthURLRequest.new }

  describe 'test an instance of OAuthURLRequest' do
    it 'should create an instance of OAuthURLRequest' do
      expect(instance).to be_instance_of(Carbon::OAuthURLRequest)
    end
  end
  ...
  describe 'test attribute "microsoft_tenant"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "sharepoint_site_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "confluence_subdomain"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
