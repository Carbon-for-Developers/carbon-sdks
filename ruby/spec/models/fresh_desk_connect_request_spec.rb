...
# Unit tests for Carbon::FreshDeskConnectRequest
describe Carbon::FreshDeskConnectRequest do
  let(:instance) { Carbon::FreshDeskConnectRequest.new }

  describe 'test an instance of FreshDeskConnectRequest' do
    it 'should create an instance of FreshDeskConnectRequest' do
      expect(instance).to be_instance_of(Carbon::FreshDeskConnectRequest)
    end
  end
