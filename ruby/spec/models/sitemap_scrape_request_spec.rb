...
# Unit tests for Carbon::SitemapScrapeRequest
describe Carbon::SitemapScrapeRequest do
  let(:instance) { Carbon::SitemapScrapeRequest.new }

  describe 'test an instance of SitemapScrapeRequest' do
    it 'should create an instance of SitemapScrapeRequest' do
      expect(instance).to be_instance_of(Carbon::SitemapScrapeRequest)
    end
  end
