...
# Unit tests for Carbon::S3FileSyncInput
describe Carbon::S3FileSyncInput do
  let(:instance) { Carbon::S3FileSyncInput.new }

  describe 'test an instance of S3FileSyncInput' do
    it 'should create an instance of S3FileSyncInput' do
      expect(instance).to be_instance_of(Carbon::S3FileSyncInput)
    end
  end
