...
# Unit tests for Carbon::OutlookSyncInput
describe Carbon::OutlookSyncInput do
  let(:instance) { Carbon::OutlookSyncInput.new }

  describe 'test an instance of OutlookSyncInput' do
    it 'should create an instance of OutlookSyncInput' do
      expect(instance).to be_instance_of(Carbon::OutlookSyncInput)
    end
  end
