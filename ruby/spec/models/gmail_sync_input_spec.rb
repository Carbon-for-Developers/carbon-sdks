...
# Unit tests for Carbon::GmailSyncInput
describe Carbon::GmailSyncInput do
  let(:instance) { Carbon::GmailSyncInput.new }

  describe 'test an instance of GmailSyncInput' do
    it 'should create an instance of GmailSyncInput' do
      expect(instance).to be_instance_of(Carbon::GmailSyncInput)
    end
  end
