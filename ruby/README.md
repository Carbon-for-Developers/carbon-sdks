...
##### tags: [`Hash<String, Tags1>`](./lib/carbon/models/hash_string_tags1.rb)<a id="tags-hashlibcarbonmodelshash_string_tags1rb"></a>

A set of tags to limit the search to. Deprecated and may be removed in the future.

##### query_vector: [`Array<Float>`](./lib/carbon/models/array_float.rb)<a id="query_vector-arraylibcarbonmodelsarray_floatrb"></a>
...
##### file_ids: [`Array<Integer>`](./lib/carbon/models/array_integer.rb)<a id="file_ids-arraylibcarbonmodelsarray_integerrb"></a>

Optional list of file IDs to limit the search to

##### parent_file_ids: [`Array<Integer>`](./lib/carbon/models/array_integer.rb)<a id="parent_file_ids-arraylibcarbonmodelsarray_integerrb"></a>
...
##### chunks_and_embeddings: [`Array<SingleChunksAndEmbeddingsUploadInput>`](./lib/carbon/models/array_single_chunks_and_embeddings_upload_input.rb)<a id="chunks_and_embeddings-arraylibcarbonmodelsarray_single_chunks_and_embeddings_upload_inputrb"></a>
...
##### sync_statuses: [`Array<ExternalFileSyncStatuses>`](./lib/carbon/models/array_external_file_sync_statuses.rb)<a id="sync_statuses-arraylibcarbonmodelsarray_external_file_sync_statusesrb"></a>
...
##### ids: [`Array<String>`](./lib/carbon/models/array_string.rb)<a id="ids-arraylibcarbonmodelsarray_stringrb"></a>
...
##### ids: [`Array<S3GetFileInput>`](./lib/carbon/models/array_s3_get_file_input.rb)<a id="ids-arraylibcarbonmodelsarray_s3_get_file_inputrb"></a>
...
##### html_tags_to_skip: [`Array<String>`](./lib/carbon/models/array_string.rb)<a id="html_tags_to_skip-arraylibcarbonmodelsarray_stringrb"></a>

##### css_classes_to_skip: [`Array<String>`](./lib/carbon/models/array_string.rb)<a id="css_classes_to_skip-arraylibcarbonmodelsarray_stringrb"></a>
