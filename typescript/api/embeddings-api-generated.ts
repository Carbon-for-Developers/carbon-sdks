...
export const EmbeddingsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getDocuments: async (getEmbeddingDocumentsBody: GetEmbeddingDocumentsBody, customerId?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getEmbeddingsAndChunks: async (embeddingsAndChunksQueryInput: EmbeddingsAndChunksQueryInput, customerId?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        uploadChunksAndEmbeddings: async (chunksAndEmbeddingsUploadInput: ChunksAndEmbeddingsUploadInput, customerId?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const EmbeddingsApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async getDocuments(requestParameters: EmbeddingsApiGetDocumentsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DocumentResponseList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getDocuments(requestParameters, requestParameters.customerId, options);
        ...
        async getEmbeddingsAndChunks(requestParameters: EmbeddingsApiGetEmbeddingsAndChunksRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EmbeddingsAndChunksResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getEmbeddingsAndChunks(requestParameters, requestParameters.customerId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
        ...
        async uploadChunksAndEmbeddings(requestParameters: EmbeddingsApiUploadChunksAndEmbeddingsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GenericSuccessResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.uploadChunksAndEmbeddings(requestParameters, requestParameters.customerId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export type EmbeddingsApiGetDocumentsRequest = {
    ...
    * 
    * @type {string}
    * @memberof EmbeddingsApiGetDocuments
    */
...
export type EmbeddingsApiGetEmbeddingsAndChunksRequest = {
    ...
    * 
    * @type {string}
    * @memberof EmbeddingsApiGetEmbeddingsAndChunks
    */
    readonly customerId?: string
...
export type EmbeddingsApiUploadChunksAndEmbeddingsRequest = {
    ...
    * 
    * @type {string}
    * @memberof EmbeddingsApiUploadChunksAndEmbeddings
    */
    readonly customerId?: string
