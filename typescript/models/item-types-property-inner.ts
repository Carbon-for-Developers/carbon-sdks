 ...
 * @export
 */
export type ItemTypesPropertyInner = SharedSourceItemTypes | HelpdeskFileTypes | ServiceNowFileTypes | ZendeskFileTypes | IntercomFileTypes | ConfluenceFileTypes | GitbookFileTypes | GithubFileTypes | GuruFileTypes | GongFileTypes | string;
