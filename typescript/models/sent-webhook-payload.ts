...
type SentWebhookPayloadWebhookTypeEnum = 'ADD' | 'ALL_FILES_PROCESSED' | 'ALL_UPLOADED_FILES_QUEUED' | 'CANCEL' | 'CHECKUP' | 'DATA_SOURCE_READY' | 'EMBEDDING_STORAGE_MODIFIED' | 'FILES_CREATED' | 'FILES_SKIPPED' | 'FILE_DELETED' | 'FILE_ERROR' | 'FILE_READY' | 'FILE_STATISTICS_AGGREGATED' | 'FILE_SYNCING' | 'FILE_SYNC_LIMIT_REACHED' | 'MOVED_TO_COLD_STORAGE' | 'MOVED_TO_HOT_STORAGE' | 'ORGANIZATION_USER_DELETED' | 'RATE_LIMIT_ERROR' | 'REVOKE' | 'SPARSE_VECTOR_QUEUE_STATUS' | 'UPDATE' | 'WEBPAGE_ERROR' | 'WEBPAGE_READY' | 'WEBSCRAPE_URLS_READY'
