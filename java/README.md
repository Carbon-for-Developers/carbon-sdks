...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v0.1.33-blue)](https://central.sonatype.com/artifact/com.konfigthis.carbonai/carbonai-java-sdk/0.1.33)
...
dependencies {
   implementation "com.konfigthis.carbonai:carbonai-java-sdk:0.1.33"
}
```
...
* `target/carbonai-java-sdk-0.1.33.jar`
* `target/lib/*.jar`
