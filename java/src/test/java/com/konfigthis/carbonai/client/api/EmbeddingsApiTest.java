...
public class EmbeddingsApiTest {
    ...
    public void getDocumentsTest() throws ApiException {
        ...
        List<Integer> parentFileIds = null;
        Boolean includeAllChildren = null;
        Object tagsV2 = null;
        Boolean includeTags = null;
        Boolean includeVectors = null;
        Boolean includeRawFile = null;
        Boolean hybridSearch = null;
        ...
        List<HSNFileTypes1> fileTypesAtSource = null;
     ...
     */
    @Test
    public void getEmbeddingsAndChunksTest() throws ApiException {
        EmbeddingsAndChunksFilters filters = null;
        Pagination pagination = null;
        EmbeddingsAndChunksOrderByColumns orderBy = null;
     ...
     */
    @Test
    public void uploadChunksAndEmbeddingsTest() throws ApiException {
        EmbeddingGenerators embeddingModel = null;
        List<SingleChunksAndEmbeddingsUploadInput> chunksAndEmbeddings = null;
        Boolean overwriteExisting = null;
        Boolean chunksOnly = null;
        Map<String, Object> customCredentials = null;
        GenericSuccessResponse response = api.uploadChunksAndEmbeddings(embeddingModel, chunksAndEmbeddings)
