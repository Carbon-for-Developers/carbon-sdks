...
public class S3FileSyncInput {
  ...
  private List<S3GetFileInput> ids = new ArrayList<>();
  ...
  public S3FileSyncInput() {
  }

  public S3FileSyncInput tags(Object tags) {
  ...
  **/
  ...
  public S3FileSyncInput ids(List<S3GetFileInput> ids) {
  ...
  public S3FileSyncInput addIdsItem(S3GetFileInput idsItem) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Each input should be one of the following: A bucket name, a bucket name and a prefix, or a          bucket name and an object key. A prefix is the common path for all objects you want to sync.          Paths should end with a forward slash.")

  public List<S3GetFileInput> getIds() {
    return ids;
  }


  public void setIds(List<S3GetFileInput> ids) {
  ...
  public S3FileSyncInput chunkSize(Integer chunkSize) {
  ...
  **/
  ...
  public S3FileSyncInput chunkOverlap(Integer chunkOverlap) {
  ...
  **/
  ...
  public S3FileSyncInput skipEmbeddingGeneration(Boolean skipEmbeddingGeneration) {
  ...
  **/
  ...
  public S3FileSyncInput embeddingModel(EmbeddingGenerators embeddingModel) {
  ...
  **/
  ...
  public S3FileSyncInput generateSparseVectors(Boolean generateSparseVectors) {
  ...
  **/
  ...
  public S3FileSyncInput prependFilenameToChunks(Boolean prependFilenameToChunks) {
  ...
  **/
  ...
  public S3FileSyncInput maxItemsPerChunk(Integer maxItemsPerChunk) {
  ...
  **/
  ...
  public S3FileSyncInput setPageAsBoundary(Boolean setPageAsBoundary) {
  ...
  **/
  ...
  public S3FileSyncInput dataSourceId(Integer dataSourceId) {
  ...
  **/
  ...
  public S3FileSyncInput requestId(String requestId) {
  ...
  **/
  ...
  public S3FileSyncInput useOcr(Boolean useOcr) {
  ...
  **/
  ...
  public S3FileSyncInput parsePdfTablesWithOcr(Boolean parsePdfTablesWithOcr) {
  ...
  **/
  ...
  public S3FileSyncInput fileSyncConfig(FileSyncConfigNullable fileSyncConfig) {
  ...
  **/
   ...
   * @return the S3FileSyncInput instance itself
   */
  public S3FileSyncInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    S3FileSyncInput s3FileSyncInput = (S3FileSyncInput) o;
    return Objects.equals(this.tags, s3FileSyncInput.tags) &&
        Objects.equals(this.ids, s3FileSyncInput.ids) &&
        Objects.equals(this.chunkSize, s3FileSyncInput.chunkSize) &&
        Objects.equals(this.chunkOverlap, s3FileSyncInput.chunkOverlap) &&
        Objects.equals(this.skipEmbeddingGeneration, s3FileSyncInput.skipEmbeddingGeneration) &&
        Objects.equals(this.embeddingModel, s3FileSyncInput.embeddingModel) &&
        Objects.equals(this.generateSparseVectors, s3FileSyncInput.generateSparseVectors) &&
        Objects.equals(this.prependFilenameToChunks, s3FileSyncInput.prependFilenameToChunks) &&
        Objects.equals(this.maxItemsPerChunk, s3FileSyncInput.maxItemsPerChunk) &&
        Objects.equals(this.setPageAsBoundary, s3FileSyncInput.setPageAsBoundary) &&
        Objects.equals(this.dataSourceId, s3FileSyncInput.dataSourceId) &&
        Objects.equals(this.requestId, s3FileSyncInput.requestId) &&
        Objects.equals(this.useOcr, s3FileSyncInput.useOcr) &&
        Objects.equals(this.parsePdfTablesWithOcr, s3FileSyncInput.parsePdfTablesWithOcr) &&
        Objects.equals(this.fileSyncConfig, s3FileSyncInput.fileSyncConfig)&&
        Objects.equals(this.additionalProperties, s3FileSyncInput.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class S3FileSyncInput {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to S3FileSyncInput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!S3FileSyncInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in S3FileSyncInput is not found in the empty JSON string", S3FileSyncInput.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : S3FileSyncInput.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayids.size(); i++) {
        S3GetFileInput.validateJsonObject(jsonArrayids.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!S3FileSyncInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'S3FileSyncInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<S3FileSyncInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(S3FileSyncInput.class));

       return (TypeAdapter<T>) new TypeAdapter<S3FileSyncInput>() {
           @Override
           public void write(JsonWriter out, S3FileSyncInput value) throws IOException {
           ...
           @Override
           public S3FileSyncInput read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             S3FileSyncInput instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of S3FileSyncInput given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of S3FileSyncInput
  * @throws IOException if the JSON string is invalid with respect to S3FileSyncInput
  */
  public static S3FileSyncInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, S3FileSyncInput.class);
  }

 /**
  * Convert an instance of S3FileSyncInput to an JSON string
  *
  * @return JSON string
  */
