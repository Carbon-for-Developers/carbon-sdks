...
public class GitbookSyncRequest {
  ...
  public GitbookSyncRequest tags(Object tags) {
  ...
  **/
  ...
  public GitbookSyncRequest spaceIds(List<String> spaceIds) {
  ...
  public GitbookSyncRequest addSpaceIdsItem(String spaceIdsItem) {
  ...
  **/
  ...
  public GitbookSyncRequest dataSourceId(Integer dataSourceId) {
  ...
  **/
  ...
  public GitbookSyncRequest chunkSize(Integer chunkSize) {
  ...
  **/
  ...
  public GitbookSyncRequest chunkOverlap(Integer chunkOverlap) {
  ...
  **/
  ...
  public GitbookSyncRequest skipEmbeddingGeneration(Boolean skipEmbeddingGeneration) {
  ...
  **/
  ...
  public GitbookSyncRequest embeddingModel(EmbeddingGenerators embeddingModel) {
  ...
  **/
  ...
  public GitbookSyncRequest generateSparseVectors(Boolean generateSparseVectors) {
  ...
  **/
  ...
  public GitbookSyncRequest prependFilenameToChunks(Boolean prependFilenameToChunks) {
  ...
  **/
  ...
  public GitbookSyncRequest requestId(String requestId) {
  ...
  **/
   ...
   * @return the GitbookSyncRequest instance itself
   */
  public GitbookSyncRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GitbookSyncRequest gitbookSyncRequest = (GitbookSyncRequest) o;
    return Objects.equals(this.tags, gitbookSyncRequest.tags) &&
        Objects.equals(this.spaceIds, gitbookSyncRequest.spaceIds) &&
        Objects.equals(this.dataSourceId, gitbookSyncRequest.dataSourceId) &&
        Objects.equals(this.chunkSize, gitbookSyncRequest.chunkSize) &&
        Objects.equals(this.chunkOverlap, gitbookSyncRequest.chunkOverlap) &&
        Objects.equals(this.skipEmbeddingGeneration, gitbookSyncRequest.skipEmbeddingGeneration) &&
  ...
  public String toString() {
    ...
    sb.append("class GitbookSyncRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("space_ids");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GitbookSyncRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GitbookSyncRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GitbookSyncRequest is not found in the empty JSON string", GitbookSyncRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GitbookSyncRequest.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // ensure the required json array is present
      if (jsonObj.get("space_ids") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("space_ids").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GitbookSyncRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GitbookSyncRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GitbookSyncRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GitbookSyncRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GitbookSyncRequest>() {
           @Override
           public void write(JsonWriter out, GitbookSyncRequest value) throws IOException {
           ...
           @Override
           public GitbookSyncRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GitbookSyncRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GitbookSyncRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GitbookSyncRequest
  * @throws IOException if the JSON string is invalid with respect to GitbookSyncRequest
  */
  public static GitbookSyncRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GitbookSyncRequest.class);
  }

 /**
  * Convert an instance of GitbookSyncRequest to an JSON string
  *
  * @return JSON string
  */
