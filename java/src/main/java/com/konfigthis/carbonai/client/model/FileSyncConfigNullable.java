 ...
 */
@ApiModel(description = "Used to configure file syncing for certain connectors when sync_files_on_connection is set to true")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FileSyncConfigNullable {
  ...
  **/
  ...
  public FileSyncConfigNullable syncAttachments(Boolean syncAttachments) {
  ...
  **/
  ...
  public FileSyncConfigNullable detectAudioLanguage(Boolean detectAudioLanguage) {
  ...
  **/
  ...
  public FileSyncConfigNullable parsedTextFormat(ParsedTextFormatsNullable parsedTextFormat) {
  ...
  **/
   ...
   * @return the FileSyncConfigNullable instance itself
   */
  public FileSyncConfigNullable putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.autoSyncedSourceTypes, fileSyncConfigNullable.autoSyncedSourceTypes) &&
        ...
        Objects.equals(this.parsedTextFormat, fileSyncConfigNullable.parsedTextFormat)&&
  ...
  public String toString() {
    ...
    sb.append("class FileSyncConfigNullable {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileSyncConfigNullable
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileSyncConfigNullable.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileSyncConfigNullable is not found in the empty JSON string", FileSyncConfigNullable.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileSyncConfigNullable.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileSyncConfigNullable' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileSyncConfigNullable> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileSyncConfigNullable.class));

       return (TypeAdapter<T>) new TypeAdapter<FileSyncConfigNullable>() {
           @Override
           public void write(JsonWriter out, FileSyncConfigNullable value) throws IOException {
           ...
           @Override
           public FileSyncConfigNullable read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FileSyncConfigNullable instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FileSyncConfigNullable given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FileSyncConfigNullable
  * @throws IOException if the JSON string is invalid with respect to FileSyncConfigNullable
  */
  public static FileSyncConfigNullable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileSyncConfigNullable.class);
  }

 /**
  * Convert an instance of FileSyncConfigNullable to an JSON string
  *
  * @return JSON string
  */
