...
import com.konfigthis.carbonai.client.model.PRFile;
...
public class FilesResponse {
  ...
  private List<PRFile> data = new ArrayList<>();
  ...
  public FilesResponse data(List<PRFile> data) {
  ...
  public FilesResponse addDataItem(PRFile dataItem) {
  ...
  **/
  ...
  public List<PRFile> getData() {
    return data;
  }


  public void setData(List<PRFile> data) {
  ...
  public FilesResponse nextCursor(String nextCursor) {
  ...
  **/
   ...
   * @return the FilesResponse instance itself
   */
  public FilesResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, filesResponse.data) &&
        Objects.equals(this.nextCursor, filesResponse.nextCursor)&&
        Objects.equals(this.additionalProperties, filesResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FilesResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FilesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : FilesResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        PRFile.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FilesResponse>() {
           ...
           public FilesResponse read(JsonReader in) throws IOException {
             ...
             FilesResponse instance = thisAdapter.fromJsonTree(jsonObj);
