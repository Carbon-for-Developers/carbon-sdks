...
public class IntegrationsApiGenerated {
    ...
    public abstract class ConnectDataSourceRequestBuilderGenerated {
        final OANSCZGFB authentication;
        SyncOptions syncOptions;

        public ConnectDataSourceRequestBuilderGenerated(OANSCZGFB authentication) {
     ...
     */
    public IntegrationsApi.ConnectDataSourceRequestBuilder connectDataSource(OANSCZGFB authentication) throws IllegalArgumentException {
