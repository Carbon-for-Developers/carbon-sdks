...
public class FileSyncConfig {
  ...
  private List<HSNFileTypes> autoSyncedSourceTypes = null;
  ...
  public FileSyncConfig autoSyncedSourceTypes(List<HSNFileTypes> autoSyncedSourceTypes) {
  ...
  **/
  ...
  public List<HSNFileTypes> getAutoSyncedSourceTypes() {
    return autoSyncedSourceTypes;
  }


  public void setAutoSyncedSourceTypes(List<HSNFileTypes> autoSyncedSourceTypes) {
