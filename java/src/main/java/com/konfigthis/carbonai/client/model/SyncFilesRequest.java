...
public class SyncFilesRequest {
  ...
  private String requestId = "9fe9190e-384f-4baa-a416-d51ed93d1be7";
  ...
  public SyncFilesRequest tags(Object tags) {
  ...
  **/
  ...
  public SyncFilesRequest dataSourceId(Integer dataSourceId) {
  ...
  **/
  ...
  public SyncFilesRequest ids(List<Object> ids) {
  ...
  public SyncFilesRequest addIdsItem(Object idsItem) {
  ...
  **/
  ...
  public SyncFilesRequest chunkSize(Integer chunkSize) {
  ...
  **/
  ...
  public SyncFilesRequest chunkOverlap(Integer chunkOverlap) {
  ...
  **/
  ...
  public SyncFilesRequest skipEmbeddingGeneration(Boolean skipEmbeddingGeneration) {
  ...
  **/
  ...
  public SyncFilesRequest embeddingModel(EmbeddingGeneratorsNullable embeddingModel) {
  ...
  **/
  ...
  public SyncFilesRequest generateSparseVectors(Boolean generateSparseVectors) {
  ...
  **/
  ...
  public SyncFilesRequest prependFilenameToChunks(Boolean prependFilenameToChunks) {
  ...
  **/
  ...
  public SyncFilesRequest maxItemsPerChunk(Integer maxItemsPerChunk) {
  ...
  **/
  ...
  public SyncFilesRequest setPageAsBoundary(Boolean setPageAsBoundary) {
  ...
  **/
  ...
  public SyncFilesRequest requestId(String requestId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "9fe9190e-384f-4baa-a416-d51ed93d1be7", value = "")
  ...
  public SyncFilesRequest useOcr(Boolean useOcr) {
  ...
  **/
  ...
  public SyncFilesRequest parsePdfTablesWithOcr(Boolean parsePdfTablesWithOcr) {
  ...
  **/
  ...
  public SyncFilesRequest incrementalSync(Boolean incrementalSync) {
  ...
  **/
  ...
  public SyncFilesRequest fileSyncConfig(FileSyncConfigNullable fileSyncConfig) {
  ...
  **/
   ...
   * @return the SyncFilesRequest instance itself
   */
  public SyncFilesRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SyncFilesRequest syncFilesRequest = (SyncFilesRequest) o;
    return Objects.equals(this.tags, syncFilesRequest.tags) &&
        Objects.equals(this.dataSourceId, syncFilesRequest.dataSourceId) &&
        Objects.equals(this.ids, syncFilesRequest.ids) &&
        Objects.equals(this.chunkSize, syncFilesRequest.chunkSize) &&
        Objects.equals(this.chunkOverlap, syncFilesRequest.chunkOverlap) &&
        Objects.equals(this.skipEmbeddingGeneration, syncFilesRequest.skipEmbeddingGeneration) &&
        Objects.equals(this.embeddingModel, syncFilesRequest.embeddingModel) &&
        Objects.equals(this.generateSparseVectors, syncFilesRequest.generateSparseVectors) &&
        Objects.equals(this.prependFilenameToChunks, syncFilesRequest.prependFilenameToChunks) &&
        Objects.equals(this.maxItemsPerChunk, syncFilesRequest.maxItemsPerChunk) &&
        Objects.equals(this.setPageAsBoundary, syncFilesRequest.setPageAsBoundary) &&
        Objects.equals(this.requestId, syncFilesRequest.requestId) &&
        Objects.equals(this.useOcr, syncFilesRequest.useOcr) &&
        Objects.equals(this.parsePdfTablesWithOcr, syncFilesRequest.parsePdfTablesWithOcr) &&
        Objects.equals(this.incrementalSync, syncFilesRequest.incrementalSync) &&
        Objects.equals(this.fileSyncConfig, syncFilesRequest.fileSyncConfig)&&
        Objects.equals(this.additionalProperties, syncFilesRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, dataSourceId, ids, chunkSize, chunkOverlap, skipEmbeddingGeneration, embeddingModel, generateSparseVectors, prependFilenameToChunks, maxItemsPerChunk, setPageAsBoundary, requestId, useOcr, parsePdfTablesWithOcr, incrementalSync, fileSyncConfig, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SyncFilesRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyncFilesRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SyncFilesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyncFilesRequest is not found in the empty JSON string", SyncFilesRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SyncFilesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyncFilesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyncFilesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyncFilesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyncFilesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SyncFilesRequest>() {
           @Override
           public void write(JsonWriter out, SyncFilesRequest value) throws IOException {
           ...
           @Override
           public SyncFilesRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SyncFilesRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SyncFilesRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyncFilesRequest
  * @throws IOException if the JSON string is invalid with respect to SyncFilesRequest
  */
  public static SyncFilesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyncFilesRequest.class);
  }

 /**
  * Convert an instance of SyncFilesRequest to an JSON string
  *
  * @return JSON string
  */
