...
public class PhoneNumber {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(phoneNumber, phoneNumberType, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("phone_number_type");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("phone_number");
    openapiRequiredFields.add("phone_number_type");
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (!jsonObj.get("phone_number_type").isJsonNull() && !jsonObj.get("phone_number_type").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `phone_number_type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("phone_number_type").toString()));
      }
  }
