...
public class AzureBlobFileSyncInput {
  ...
  private List<AzureBlobGetFileInput> ids = new ArrayList<>();
  ...
  public AzureBlobFileSyncInput() {
  }

  public AzureBlobFileSyncInput tags(Object tags) {
  ...
  **/
  ...
  public AzureBlobFileSyncInput ids(List<AzureBlobGetFileInput> ids) {
  ...
  public AzureBlobFileSyncInput addIdsItem(AzureBlobGetFileInput idsItem) {
  ...
  **/
  ...
  public List<AzureBlobGetFileInput> getIds() {
    return ids;
  }


  public void setIds(List<AzureBlobGetFileInput> ids) {
  ...
  public AzureBlobFileSyncInput chunkSize(Integer chunkSize) {
  ...
  **/
  ...
  public AzureBlobFileSyncInput chunkOverlap(Integer chunkOverlap) {
  ...
  **/
  ...
  public AzureBlobFileSyncInput skipEmbeddingGeneration(Boolean skipEmbeddingGeneration) {
  ...
  **/
  ...
  public AzureBlobFileSyncInput embeddingModel(EmbeddingGenerators embeddingModel) {
  ...
  **/
  ...
  public AzureBlobFileSyncInput generateSparseVectors(Boolean generateSparseVectors) {
  ...
  **/
  ...
  public AzureBlobFileSyncInput prependFilenameToChunks(Boolean prependFilenameToChunks) {
  ...
  **/
  ...
  public AzureBlobFileSyncInput maxItemsPerChunk(Integer maxItemsPerChunk) {
  ...
  **/
  ...
  public AzureBlobFileSyncInput setPageAsBoundary(Boolean setPageAsBoundary) {
  ...
  **/
  ...
  public AzureBlobFileSyncInput dataSourceId(Integer dataSourceId) {
  ...
  **/
  ...
  public AzureBlobFileSyncInput requestId(String requestId) {
  ...
  **/
  ...
  public AzureBlobFileSyncInput useOcr(Boolean useOcr) {
  ...
  **/
  ...
  public AzureBlobFileSyncInput parsePdfTablesWithOcr(Boolean parsePdfTablesWithOcr) {
  ...
  **/
  ...
  public AzureBlobFileSyncInput fileSyncConfig(FileSyncConfigNullable fileSyncConfig) {
  ...
  **/
   ...
   * @return the AzureBlobFileSyncInput instance itself
   */
  public AzureBlobFileSyncInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AzureBlobFileSyncInput azureBlobFileSyncInput = (AzureBlobFileSyncInput) o;
    return Objects.equals(this.tags, azureBlobFileSyncInput.tags) &&
        Objects.equals(this.ids, azureBlobFileSyncInput.ids) &&
        Objects.equals(this.chunkSize, azureBlobFileSyncInput.chunkSize) &&
        Objects.equals(this.chunkOverlap, azureBlobFileSyncInput.chunkOverlap) &&
        Objects.equals(this.skipEmbeddingGeneration, azureBlobFileSyncInput.skipEmbeddingGeneration) &&
        Objects.equals(this.embeddingModel, azureBlobFileSyncInput.embeddingModel) &&
        Objects.equals(this.generateSparseVectors, azureBlobFileSyncInput.generateSparseVectors) &&
        Objects.equals(this.prependFilenameToChunks, azureBlobFileSyncInput.prependFilenameToChunks) &&
        Objects.equals(this.maxItemsPerChunk, azureBlobFileSyncInput.maxItemsPerChunk) &&
        Objects.equals(this.setPageAsBoundary, azureBlobFileSyncInput.setPageAsBoundary) &&
        Objects.equals(this.dataSourceId, azureBlobFileSyncInput.dataSourceId) &&
        Objects.equals(this.requestId, azureBlobFileSyncInput.requestId) &&
        Objects.equals(this.useOcr, azureBlobFileSyncInput.useOcr) &&
        Objects.equals(this.parsePdfTablesWithOcr, azureBlobFileSyncInput.parsePdfTablesWithOcr) &&
        Objects.equals(this.fileSyncConfig, azureBlobFileSyncInput.fileSyncConfig)&&
        Objects.equals(this.additionalProperties, azureBlobFileSyncInput.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, ids, chunkSize, chunkOverlap, skipEmbeddingGeneration, embeddingModel, generateSparseVectors, prependFilenameToChunks, maxItemsPerChunk, setPageAsBoundary, dataSourceId, requestId, useOcr, parsePdfTablesWithOcr, fileSyncConfig, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AzureBlobFileSyncInput {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AzureBlobFileSyncInput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AzureBlobFileSyncInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AzureBlobFileSyncInput is not found in the empty JSON string", AzureBlobFileSyncInput.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AzureBlobFileSyncInput.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayids.size(); i++) {
        AzureBlobGetFileInput.validateJsonObject(jsonArrayids.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AzureBlobFileSyncInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AzureBlobFileSyncInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AzureBlobFileSyncInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AzureBlobFileSyncInput.class));

       return (TypeAdapter<T>) new TypeAdapter<AzureBlobFileSyncInput>() {
           @Override
           public void write(JsonWriter out, AzureBlobFileSyncInput value) throws IOException {
           ...
           @Override
           public AzureBlobFileSyncInput read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AzureBlobFileSyncInput instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AzureBlobFileSyncInput given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AzureBlobFileSyncInput
  * @throws IOException if the JSON string is invalid with respect to AzureBlobFileSyncInput
  */
  public static AzureBlobFileSyncInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AzureBlobFileSyncInput.class);
  }

 /**
  * Convert an instance of AzureBlobFileSyncInput to an JSON string
  *
  * @return JSON string
  */
