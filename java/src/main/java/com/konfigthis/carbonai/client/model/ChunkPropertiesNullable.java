...
public class ChunkPropertiesNullable {
  ...
  public ChunkPropertiesNullable() {
  }

  public ChunkPropertiesNullable setPageAsBoundary(Boolean setPageAsBoundary) {
  ...
  **/
  ...
  public ChunkPropertiesNullable prependFilenameToChunks(Boolean prependFilenameToChunks) {
  ...
  **/
  ...
  public ChunkPropertiesNullable maxItemsPerChunk(Integer maxItemsPerChunk) {
  ...
  **/
   ...
   * @return the ChunkPropertiesNullable instance itself
   */
  public ChunkPropertiesNullable putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ChunkPropertiesNullable chunkPropertiesNullable = (ChunkPropertiesNullable) o;
    return Objects.equals(this.setPageAsBoundary, chunkPropertiesNullable.setPageAsBoundary) &&
        Objects.equals(this.prependFilenameToChunks, chunkPropertiesNullable.prependFilenameToChunks) &&
        Objects.equals(this.maxItemsPerChunk, chunkPropertiesNullable.maxItemsPerChunk)&&
  ...
  public String toString() {
    ...
    sb.append("class ChunkPropertiesNullable {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ChunkPropertiesNullable
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChunkPropertiesNullable.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChunkPropertiesNullable' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChunkPropertiesNullable> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChunkPropertiesNullable.class));

       return (TypeAdapter<T>) new TypeAdapter<ChunkPropertiesNullable>() {
           @Override
           public void write(JsonWriter out, ChunkPropertiesNullable value) throws IOException {
           ...
           @Override
           public ChunkPropertiesNullable read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ChunkPropertiesNullable instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ChunkPropertiesNullable given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ChunkPropertiesNullable
  * @throws IOException if the JSON string is invalid with respect to ChunkPropertiesNullable
  */
  public static ChunkPropertiesNullable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChunkPropertiesNullable.class);
  }

 /**
  * Convert an instance of ChunkPropertiesNullable to an JSON string
  *
  * @return JSON string
  */
