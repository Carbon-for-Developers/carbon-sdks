...
public class OAuthURLRequest {
  ...
  private String requestId = "229bd6e7-4931-4900-8f58-0e4071e45b25";
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "229bd6e7-4931-4900-8f58-0e4071e45b25", value = "This request id will be added to all files that get synced using the generated OAuth URL")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Enable integration's file picker for sources that support it. Supported sources: DROPBOX, ONEDRIVE, SHAREPOINT, GOOGLE_DRIVE, BOX")
