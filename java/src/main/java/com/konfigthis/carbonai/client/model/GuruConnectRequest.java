...
public class GuruConnectRequest {
  ...
  public GuruConnectRequest() {
  }

  public GuruConnectRequest tags(Object tags) {
  ...
  **/
  ...
  public GuruConnectRequest username(String username) {
  ...
  **/
  ...
  public GuruConnectRequest accessToken(String accessToken) {
  ...
  **/
  ...
  public GuruConnectRequest chunkSize(Integer chunkSize) {
  ...
  **/
  ...
  public GuruConnectRequest chunkOverlap(Integer chunkOverlap) {
  ...
  **/
  ...
  public GuruConnectRequest skipEmbeddingGeneration(Boolean skipEmbeddingGeneration) {
  ...
  **/
  ...
  public GuruConnectRequest embeddingModel(EmbeddingGenerators embeddingModel) {
  ...
  **/
  ...
  public GuruConnectRequest generateSparseVectors(Boolean generateSparseVectors) {
  ...
  **/
  ...
  public GuruConnectRequest prependFilenameToChunks(Boolean prependFilenameToChunks) {
  ...
  **/
  ...
  public GuruConnectRequest syncFilesOnConnection(Boolean syncFilesOnConnection) {
  ...
  **/
  ...
  public GuruConnectRequest requestId(String requestId) {
  ...
  **/
  ...
  public GuruConnectRequest syncSourceItems(Boolean syncSourceItems) {
  ...
  **/
  ...
  public GuruConnectRequest fileSyncConfig(FileSyncConfigNullable fileSyncConfig) {
  ...
  **/
  ...
  public GuruConnectRequest dataSourceTags(Object dataSourceTags) {
  ...
  **/
   ...
   * @return the GuruConnectRequest instance itself
   */
  public GuruConnectRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GuruConnectRequest guruConnectRequest = (GuruConnectRequest) o;
    return Objects.equals(this.tags, guruConnectRequest.tags) &&
        Objects.equals(this.username, guruConnectRequest.username) &&
        Objects.equals(this.accessToken, guruConnectRequest.accessToken) &&
        Objects.equals(this.chunkSize, guruConnectRequest.chunkSize) &&
        Objects.equals(this.chunkOverlap, guruConnectRequest.chunkOverlap) &&
        Objects.equals(this.skipEmbeddingGeneration, guruConnectRequest.skipEmbeddingGeneration) &&
        Objects.equals(this.embeddingModel, guruConnectRequest.embeddingModel) &&
        Objects.equals(this.generateSparseVectors, guruConnectRequest.generateSparseVectors) &&
        Objects.equals(this.prependFilenameToChunks, guruConnectRequest.prependFilenameToChunks) &&
        Objects.equals(this.syncFilesOnConnection, guruConnectRequest.syncFilesOnConnection) &&
        Objects.equals(this.requestId, guruConnectRequest.requestId) &&
        Objects.equals(this.syncSourceItems, guruConnectRequest.syncSourceItems) &&
        Objects.equals(this.fileSyncConfig, guruConnectRequest.fileSyncConfig) &&
        Objects.equals(this.dataSourceTags, guruConnectRequest.dataSourceTags)&&
        Objects.equals(this.additionalProperties, guruConnectRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, username, accessToken, chunkSize, chunkOverlap, skipEmbeddingGeneration, embeddingModel, generateSparseVectors, prependFilenameToChunks, syncFilesOnConnection, requestId, syncSourceItems, fileSyncConfig, dataSourceTags, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class GuruConnectRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GuruConnectRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GuruConnectRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GuruConnectRequest is not found in the empty JSON string", GuruConnectRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GuruConnectRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GuruConnectRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GuruConnectRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GuruConnectRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GuruConnectRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GuruConnectRequest>() {
           @Override
           public void write(JsonWriter out, GuruConnectRequest value) throws IOException {
           ...
           @Override
           public GuruConnectRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GuruConnectRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GuruConnectRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GuruConnectRequest
  * @throws IOException if the JSON string is invalid with respect to GuruConnectRequest
  */
  public static GuruConnectRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GuruConnectRequest.class);
  }

 /**
  * Convert an instance of GuruConnectRequest to an JSON string
  *
  * @return JSON string
  */
