...
public class Document360ConnectRequest {
  public static final String SERIALIZED_NAME_TAGS = "tags";
  @SerializedName(SERIALIZED_NAME_TAGS)
  private Object tags;

  public static final String SERIALIZED_NAME_ACCOUNT_EMAIL = "account_email";
  ...
  public Document360ConnectRequest() {
  }

  public Document360ConnectRequest tags(Object tags) {
  ...
  **/
  ...
  public Document360ConnectRequest accountEmail(String accountEmail) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "This email will be used to identify your carbon data source. It should have access to the          Document360 account you wish to connect.")
  ...
  public Document360ConnectRequest accessToken(String accessToken) {
  ...
  **/
  ...
  public Document360ConnectRequest chunkSize(Integer chunkSize) {
  ...
  **/
  ...
  public Document360ConnectRequest chunkOverlap(Integer chunkOverlap) {
  ...
  **/
  ...
  public Document360ConnectRequest skipEmbeddingGeneration(Boolean skipEmbeddingGeneration) {
  ...
  **/
  ...
  public Document360ConnectRequest embeddingModel(EmbeddingGenerators embeddingModel) {
  ...
  **/
  ...
  public Document360ConnectRequest generateSparseVectors(Boolean generateSparseVectors) {
  ...
  **/
  ...
  public Document360ConnectRequest prependFilenameToChunks(Boolean prependFilenameToChunks) {
  ...
  **/
  ...
  public Document360ConnectRequest syncFilesOnConnection(Boolean syncFilesOnConnection) {
  ...
  **/
  ...
  public Document360ConnectRequest requestId(String requestId) {
  ...
  **/
  ...
  public Document360ConnectRequest syncSourceItems(Boolean syncSourceItems) {
  ...
  **/
  ...
  public Document360ConnectRequest fileSyncConfig(FileSyncConfigNullable fileSyncConfig) {
  ...
  **/
  ...
  public Document360ConnectRequest dataSourceTags(Object dataSourceTags) {
  ...
  **/
   ...
   * @return the Document360ConnectRequest instance itself
   */
  public Document360ConnectRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Document360ConnectRequest document360ConnectRequest = (Document360ConnectRequest) o;
    return Objects.equals(this.tags, document360ConnectRequest.tags) &&
        Objects.equals(this.accountEmail, document360ConnectRequest.accountEmail) &&
        Objects.equals(this.accessToken, document360ConnectRequest.accessToken) &&
        Objects.equals(this.chunkSize, document360ConnectRequest.chunkSize) &&
        Objects.equals(this.chunkOverlap, document360ConnectRequest.chunkOverlap) &&
        Objects.equals(this.skipEmbeddingGeneration, document360ConnectRequest.skipEmbeddingGeneration) &&
        Objects.equals(this.embeddingModel, document360ConnectRequest.embeddingModel) &&
        Objects.equals(this.generateSparseVectors, document360ConnectRequest.generateSparseVectors) &&
        Objects.equals(this.prependFilenameToChunks, document360ConnectRequest.prependFilenameToChunks) &&
        Objects.equals(this.syncFilesOnConnection, document360ConnectRequest.syncFilesOnConnection) &&
        Objects.equals(this.requestId, document360ConnectRequest.requestId) &&
        Objects.equals(this.syncSourceItems, document360ConnectRequest.syncSourceItems) &&
        Objects.equals(this.fileSyncConfig, document360ConnectRequest.fileSyncConfig) &&
        Objects.equals(this.dataSourceTags, document360ConnectRequest.dataSourceTags)&&
        Objects.equals(this.additionalProperties, document360ConnectRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, accountEmail, accessToken, chunkSize, chunkOverlap, skipEmbeddingGeneration, embeddingModel, generateSparseVectors, prependFilenameToChunks, syncFilesOnConnection, requestId, syncSourceItems, fileSyncConfig, dataSourceTags, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Document360ConnectRequest {\n");
  ...
  static {
    ...
    openapiFields.add("account_email");
    ...
    openapiRequiredFields.add("account_email");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Document360ConnectRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Document360ConnectRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Document360ConnectRequest is not found in the empty JSON string", Document360ConnectRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Document360ConnectRequest.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("account_email").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `account_email` to be a primitive type in the JSON string but got `%s`", jsonObj.get("account_email").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Document360ConnectRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Document360ConnectRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Document360ConnectRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Document360ConnectRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<Document360ConnectRequest>() {
           @Override
           public void write(JsonWriter out, Document360ConnectRequest value) throws IOException {
           ...
           @Override
           public Document360ConnectRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Document360ConnectRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Document360ConnectRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Document360ConnectRequest
  * @throws IOException if the JSON string is invalid with respect to Document360ConnectRequest
  */
  public static Document360ConnectRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Document360ConnectRequest.class);
  }

 /**
  * Convert an instance of Document360ConnectRequest to an JSON string
  *
  * @return JSON string
  */
