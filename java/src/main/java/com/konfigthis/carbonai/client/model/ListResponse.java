...
import com.konfigthis.carbonai.client.model.DirectoryItem;
...
public class ListResponse {
  ...
  private List<DirectoryItem> data = new ArrayList<>();

  public ListResponse() {
  }

  public ListResponse data(List<DirectoryItem> data) {
  ...
  public ListResponse addDataItem(DirectoryItem dataItem) {
  ...
  **/
  ...
  public List<DirectoryItem> getData() {
    return data;
  }


  public void setData(List<DirectoryItem> data) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, listResponse.data)&&
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : ListResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        DirectoryItem.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
  }
