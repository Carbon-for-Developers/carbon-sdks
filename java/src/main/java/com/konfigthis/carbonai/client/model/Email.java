...
public class Email {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(email, emailType, additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("email_type");
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (!jsonObj.get("email_type").isJsonNull() && !jsonObj.get("email_type").isJsonPrimitive()) {
